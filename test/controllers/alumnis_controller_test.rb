...
class AlumnisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumni" do
    assert_difference('Alumni.count') do
      post alumnis_url, params: { alumni: { email: @alumni.email, first_name: @alumni.first_name, last_name: @alumni.last_name, program: @alumni.program } }
    end
  ...
  test "should update alumni" do
    patch alumni_url(@alumni), params: { alumni: { email: @alumni.email, first_name: @alumni.first_name, last_name: @alumni.last_name, program: @alumni.program } }
